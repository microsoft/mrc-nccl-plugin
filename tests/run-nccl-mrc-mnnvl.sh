...
print_usage() {
    ...
    echo "  MPI_NETDEV: MANA NIC netdev for MPI/UCX/NCCL bootstrap (default: enP22p1s0f1)."
    ...
    echo "  BEGIN_MSG_SIZE: Starting message size (default: 1M)."
    echo "  END_MSG_SIZE: Ending message size (default: 16G). In long-running mode, the size held indefinitely."
...
BEGIN_MSG_SIZE=${BEGIN_MSG_SIZE:-1M}
